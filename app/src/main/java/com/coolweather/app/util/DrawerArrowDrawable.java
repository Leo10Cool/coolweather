...
/**
 * Created by ·É on 2015/11/4 0004.
 */
public class DrawerArrowDrawable extends Drawable {
    private static class JoinedPath {
         ...
         */
        private void getPointOnLine(float parameter, float[] coords) { //(²ÎÊý£¬×ø±ê)
            if (parameter <= .5f) {
                parameter *= 2;
     ...
     * via {@link DrawerLayout.DrawerListener#onDrawerSlide(View, float)}'s {@code slideOffset} parameter.
     */
